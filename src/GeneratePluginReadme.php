...
final class GeneratePluginReadme
{
    ...
    public static function generatePluginReadme(Event $event)/*: void*/
    {
        ...
        self::getInstance()->doGeneratePluginReadme($project_root, null, null, true, true);
    }
    ...
    public function doGeneratePluginReadme(
        string $project_root, /*?*/ string $template = null, /*?*/ array $extra_ilias_plugin = null,
...
";
        ...
        if (empty($extra_ilias_plugin)) {
            $extra_ilias_plugin = $plugin_composer_json["extra"]["ilias_plugin"];
        }
