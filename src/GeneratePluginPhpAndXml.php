...
final class GeneratePluginPhpAndXml
{
    ...
    public static function generatePluginPhpAndXml(Event $event)/*: void*/
    {
        ...
        self::getInstance()->doGeneratePluginPhpAndXml($project_root, null, true, true);
    }
     ...
     * @param bool       $log
     */
    public function doGeneratePluginPhpAndXml(string $project_root, /*?*/ array $extra_ilias_plugin = null, bool $autogenerated_comment = false, bool $log = false)/*: void*/
    {
        $plugin_composer_json = json_decode(file_get_contents($project_root . "/" . self::PLUGIN_COMPOSER_JSON));

        $extra_ilias_plugin = $this->updateMissingVariablesComposerJson($plugin_composer_json, $extra_ilias_plugin, $project_root, $log);

        $this->generatePluginPhp($plugin_composer_json, $extra_ilias_plugin, $project_root, $autogenerated_comment, $log);
...
');
     ...
     * @param bool     $log
     */
    private function generatePluginPhp(stdClass $plugin_composer_json, array $extra_ilias_plugin, string $project_root, bool $autogenerated_comment, bool $log)/* : void*/
    {
        if ($log) {
...
');
     ...
     * @return array
     */
    private function updateMissingVariablesComposerJson(stdClass $plugin_composer_json, /*?*/ array $extra_ilias_plugin = null, string $project_root, bool $log) : array
    {
