...
# fluxfw/generateplugininfoshelper Library
...
```json
"require": {
  "fluxfw/generateplugininfoshelper": ">=1.0.0"
},
```
...
```json
  ...
  "pre-autoload-dump": [
    ...,
      "fluxfw\\GeneratePluginInfosHelper\\x\\GeneratePluginPhpAndXml::generatePluginPhpAndXml"
    ]
  ...
```
...
```php
...
use fluxfw\GeneratePluginInfosHelper\x\GeneratePluginPhpAndXml; 
...
...
```json
  ...
  "pre-autoload-dump": [
    ...,
     "fluxfw\\GeneratePluginInfosHelper\\x\\GeneratePluginReadme::generatePluginReadme"
    ]
  ...
```
...
```php
...
use fluxfw\GeneratePluginInfosHelper\x\GeneratePluginReadme; 
...
